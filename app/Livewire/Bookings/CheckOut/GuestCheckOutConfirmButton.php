...
class GuestCheckOutConfirmButton extends Component
{
    ...
    public function confirm(): void
    {
        ...
        if ($checkOut && Auth::user()) {
            app(BookingCheckOutConfirmationService::class)->guestConfirm(Auth::user(), $checkOut);
    ...
    {
        return view('livewire.bookings.check-out.card', $this->checkOutViewData('guest_confirm_button'));
    }
}
