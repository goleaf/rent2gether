...
class BookingRequirementsPanel extends Component
{
    ...
    public function render(): View
    {
        ...
        return view('livewire.bookings.show.booking-requirements-panel', [
            'requirements' => $booking->requirements->sortBy('requirement_key')->values(),
        ]);
    }
}
