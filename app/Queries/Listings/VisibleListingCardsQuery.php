...
final readonly class VisibleListingCardsQuery
{
    ...
    public function handle(ListingCardContext $context): Builder
    {
        return SleepingPlace::query()
            ...
            ->leftJoin('property_current_occupancy_snapshots as search_property_occupancy_snapshots', 'search_property_occupancy_snapshots.property_id', '=', 'search_properties.id')
            ->leftJoin('room_current_occupancy_snapshots as search_room_occupancy_snapshots', 'search_room_occupancy_snapshots.room_id', '=', 'search_rooms.id')
            ->leftJoin('property_rating_snapshots as search_property_rating_snapshots', 'search_property_rating_snapshots.property_id', '=', 'search_properties.id')
            ->leftJoin('room_rating_snapshots as search_room_rating_snapshots', 'search_room_rating_snapshots.room_id', '=', 'search_rooms.id')
            ->leftJoin('sleeping_place_rating_snapshots as search_sleeping_place_rating_snapshots', 'search_sleeping_place_rating_snapshots.sleeping_place_id', '=', 'sleeping_places.id')
            ->leftJoin('room_compatibility_profiles as search_room_compatibility_profiles', 'search_room_compatibility_profiles.room_id', '=', 'search_rooms.id')
