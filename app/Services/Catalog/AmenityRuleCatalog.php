...
final class AmenityRuleCatalog
{
    ...
    public static function amenities(): array
    {
        return [
            ...
            ['slug' => 'front_door_lock', 'category' => 'safety', 'en' => 'Entrance door lock', 'ru' => 'Замок на входной двери'],
            ...
            ['slug' => 'no_private_area_cameras', 'category' => 'safety', 'en' => 'No cameras in private areas', 'ru' => 'Нет камер в личных зонах'],
            ...
            ['slug' => 'fire_safety_instructions', 'category' => 'safety', 'en' => 'Fire safety instructions', 'ru' => 'Инструкция на случай пожара'],
            ['slug' => 'emergency_exit', 'category' => 'safety', 'en' => 'Emergency exit', 'ru' => 'Аварийный выход'],
            ...
            ['slug' => 'safe', 'category' => 'safety', 'en' => 'Safe', 'ru' => 'Сейф'],
            ['slug' => 'electronic_lock', 'category' => 'safety', 'en' => 'Electronic lock', 'ru' => 'Электронный замок'],
            ['slug' => 'urgent_help_available', 'category' => 'safety', 'en' => 'Urgent help available', 'ru' => 'Срочная помощь доступна'],
    ...
    {
        return [
            ['slug' => 'smoking_allowed', 'category' => 'smoking', 'en' => 'Smoking allowed', 'ru' => 'Можно курить', 'requires_confirmation' => true],
            ...
            ['slug' => 'pets_allowed', 'category' => 'pets', 'en' => 'Pets allowed', 'ru' => 'Можно с животными', 'requires_confirmation' => true],
            ...
            ['slug' => 'visitors_allowed', 'category' => 'visitors', 'en' => 'Visitors allowed', 'ru' => 'Можно приводить гостей', 'requires_confirmation' => true],
            ['slug' => 'no_visitors', 'category' => 'visitors', 'en' => 'No visitors', 'ru' => 'Нельзя приводить гостей', 'requires_confirmation' => true],
            ['slug' => 'couples_allowed', 'category' => 'shared_room_behavior', 'en' => 'Couples allowed', 'ru' => 'Можно парам', 'requires_confirmation' => true],
            ['slug' => 'children_allowed', 'category' => 'shared_room_behavior', 'en' => 'Children allowed', 'ru' => 'Можно детям', 'requires_confirmation' => true],
            ['slug' => 'adults_only', 'category' => 'shared_room_behavior', 'en' => 'Adults only', 'ru' => 'Только взрослые', 'requires_confirmation' => true],
            ['slug' => 'cooking_allowed', 'category' => 'kitchen', 'en' => 'Cooking allowed', 'ru' => 'Можно готовить', 'requires_confirmation' => true],
            ['slug' => 'night_cooking_allowed', 'category' => 'kitchen', 'en' => 'Night cooking allowed', 'ru' => 'Можно готовить ночью', 'requires_confirmation' => true],
            ['slug' => 'no_noise_after_time', 'category' => 'quiet_hours', 'en' => 'No noise after a set time', 'ru' => 'Нельзя шуметь после определенного времени', 'requires_confirmation' => true],
            ...
            ['slug' => 'washing_machine_at_night_allowed', 'category' => 'quiet_hours', 'en' => 'Night washing allowed', 'ru' => 'Можно стирать ночью', 'requires_confirmation' => true],
            ['slug' => 'night_work_allowed', 'category' => 'quiet_hours', 'en' => 'Night work allowed', 'ru' => 'Можно работать ночью', 'requires_confirmation' => true],
            ['slug' => 'late_entry_allowed', 'category' => 'check_in_out', 'en' => 'Late return allowed', 'ru' => 'Можно возвращаться поздно', 'requires_confirmation' => true],
            ['slug' => 'entry_time_limit', 'category' => 'check_in_out', 'en' => 'Entry time limit', 'ru' => 'Есть ограничение по времени входа', 'requires_confirmation' => true],
            ['slug' => 'cleaning_rules', 'category' => 'cleanliness', 'en' => 'Cleaning rules', 'ru' => 'Есть правила уборки', 'requires_confirmation' => true],
            ['slug' => 'cleaning_schedule', 'category' => 'cleanliness', 'en' => 'Cleaning schedule', 'ru' => 'Есть график уборки', 'requires_confirmation' => true],
            ...
            ['slug' => 'do_not_use_other_residents_things', 'category' => 'shared_room_behavior', 'en' => "Do not use other residents' things", 'ru' => 'Нельзя использовать вещи других жильцов', 'requires_confirmation' => true],
            ...
            ['slug' => 'no_alcohol', 'category' => 'alcohol_parties', 'en' => 'No alcohol', 'ru' => 'Нельзя алкоголь', 'requires_confirmation' => true],
            ['slug' => 'no_unregistered_people', 'category' => 'visitors', 'en' => 'No unregistered people', 'ru' => 'Нельзя посторонних людей', 'requires_confirmation' => true],
            ['slug' => 'no_loud_music', 'category' => 'quiet_hours', 'en' => 'No loud music', 'ru' => 'Нельзя громкая музыка', 'requires_confirmation' => true],
            ['slug' => 'no_food_storage_in_room', 'category' => 'kitchen', 'en' => 'No food storage in the room', 'ru' => 'Нельзя хранить еду в комнате', 'requires_confirmation' => true],
            ['slug' => 'no_eating_on_bed', 'category' => 'shared_room_behavior', 'en' => 'No eating on the bed', 'ru' => 'Нельзя есть на кровати', 'requires_confirmation' => true],
            ['slug' => 'no_sleeping_place_changes_without_permission', 'category' => 'shared_room_behavior', 'en' => 'Do not change sleeping place without permission', 'ru' => 'Нельзя менять спальное место без разрешения', 'requires_confirmation' => true],
        ];
    }
