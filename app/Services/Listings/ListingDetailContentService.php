...
class ListingDetailContentService
{
        ...
        return [
            'sections' => $this->sections->visibleSections([
                [
                    'key' => 'description',
                    'items' => $this->items([
                        $this->item('listing_detail.fields.listing_title', $this->listingTitle($place, $placeTranslations)),
                        $this->item('listing_detail.fields.short_description', $this->firstText([
                            $this->field($placeTranslations, 'short_description', ['summary']),
                            $this->field($roomTranslations, 'short_description', ['summary']),
                            $this->field($propertyTranslations, 'short_description', ['summary']),
                        ])),
                        ...
                        $this->item('listing_detail.fields.full_description', $this->firstText([
                            $this->field($placeTranslations, 'full_description'),
                            $this->field($roomTranslations, 'full_description'),
                            $this->field($propertyTranslations, 'full_description', ['description']),
                        ])),
                        ...
                        $this->item('listing_detail.fields.pros', $this->firstText([
                            $this->field($placeTranslations, 'main_pros', ['sleeping_place_pros']),
                        ...
                        $this->item('listing_detail.fields.cons', $this->firstText([
                            $this->field($placeTranslations, 'important_cons', ['sleeping_place_cons']),
                            $this->field($roomTranslations, 'room_cons'),
                            $this->field($propertyTranslations, 'important_cons'),
                        ])),
                        $this->item('listing_detail.fields.what_to_know', $this->firstText([
                            $this->field($placeTranslations, 'special_notes', ['sleeping_place_special_notes']),
                            $this->field($roomTranslations, 'special_notes', ['notes']),
                            $this->field($propertyTranslations, 'what_to_know_beforehand', ['what_to_know', 'important_notes']),
                        ])),
                    ]),
                ],
                [
                    ...
                    'items' => $this->items([
                        ...
                        $this->item('listing_detail.fields.included_for_place', $this->field($placeTranslations, 'what_is_included', ['what_is_included_for_place'])),
                ...
                [
                    ...
                    'items' => $this->items([
                        ...
                        $this->item('listing_detail.fields.bring_for_place', $this->field($placeTranslations, 'what_guest_should_bring', ['what_guest_should_bring_for_place'])),
                    ]),
                ],
                [
                    'key' => 'storage',
                    'items' => $this->items([
                        $this->item('listing_detail.fields.sleeping_place_storage', $this->field($placeTranslations, 'storage_instructions')),
                ...
                [
                    'key' => 'food_storage',
                    'items' => $this->items([
                        $this->item('listing_detail.fields.food_storage', $this->firstText([
                            $this->field($propertyTranslations, 'where_to_store_food'),
                            $this->field($roomTranslations, 'food_rules_text'),
                        ])),
                    ]),
                ],
                [
    ...
    private function listingTitle(SleepingPlace $place, Collection $placeTranslations): ?string
    {
        return $this->firstText([
            $this->field($placeTranslations, 'title', ['sleeping_place_title']),
            $place->display_name,
    ...
    private function keyItems(SleepingPlace $place, ?User $viewer, Collection $propertyTranslations): array
    {
        ...
        $canShowEntryInstructions = $this->privacy->canShowEntryInstructions($place->property, $viewer);

        if ($canShowEntryInstructions) {
        ...
        } elseif ($this->field($propertyTranslations, 'key_pickup_instructions') !== null) {
            $items[] = $this->item('listing_detail.fields.key_pickup', __('listing_detail.hints.address_after_booking'));
        }

        if (! $canShowEntryInstructions && $this->field($propertyTranslations, 'night_entry_instructions') !== null) {
            $items[] = $this->item('listing_detail.fields.night_entry', __('listing_detail.hints.address_after_booking'));
        }
