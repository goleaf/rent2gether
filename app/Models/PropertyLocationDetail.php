...
class PropertyLocationDetail extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'near_work_area' => 'boolean',
            'near_sea' => 'boolean',
            'near_nightlife' => 'boolean',
            'area_residential' => 'boolean',
            'area_city_center' => 'boolean',
            'area_suburb' => 'boolean',
            'area_industrial' => 'boolean',
            'area_tourist' => 'boolean',
            'area_students' => 'boolean',
            'area_workers' => 'boolean',
            'area_long_stay' => 'boolean',
        ];
    }
