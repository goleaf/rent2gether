...
return [
    ...
    'validation' => [
        ...
        'closed_by_service' => 'Сервис временно закрыл эти даты.',
        ...
        'broken' => 'Это спальное место нужно починить перед бронированием.',
        'complaint_block' => 'Проживание недоступно из-за активной блокировки по жалобе.',
        'hidden' => 'Это спальное место временно скрыто на эти даты.',
        ...
        'below_min_nights_checkout' => 'Эта дата выезда раньше минимального срока проживания.',
        'above_max_nights_checkout' => 'Эта дата выезда позже максимального срока проживания.',
    ...
    'messages' => [
        ...
        'earliest_checkout' => 'Самая ранняя дата выезда',
        'latest_checkout' => 'Самая поздняя дата выезда',
        'blocked_checkout_dates' => 'Недоступные даты выезда',
        'checkout_unavailable_reason' => ':date недоступна: :reason',
        'alternatives_available' => 'Если эти даты не подходят, рядом есть похожие варианты.',
