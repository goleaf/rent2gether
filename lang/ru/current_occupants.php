...
return [
    ...
    'fields' => [
        ...
        'needs_checkout' => 'Нужно выселение',
    ...
    'filters' => [
        ...
        'only_needs_attention' => 'Показать только проживание, где нужно внимание',
    ...
    'cards' => [
        ...
        'subtitle' => 'В каждой карточке видны гость, комната, даты, оплата, статус проживания, связь, пожелания, жалобы, продление, выселение и комментарий хозяина.',
    ],

    'loading' => [
        'refreshing' => 'Обновляем список жильцов...',
    ],

    'values' => [
        'avatar_alt' => 'Фото гостя :name',
        'not_available' => 'Нет данных',
        'chat_available' => 'Доступен чат',
        'contact_hidden' => 'Контакт скрыт, пока проживание не позволяет его показать',
        'no_special_requests' => 'Особых пожеланий нет',
        'rating' => ':rating / 5',
        'no_rating' => 'Рейтинга гостя пока нет',
        'complaints_count' => '{0} Жалоб нет|{1} :count открытая жалоба|[2,4] :count открытые жалобы|[5,*] :count открытых жалоб',
        'no_complaints' => 'Жалоб нет',
        'no_host_comment' => 'Комментария хозяина пока нет',
        'yes' => 'Да',
        'no' => 'Нет',
    ],
