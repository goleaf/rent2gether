<div class="mx-auto max-w-2xl space-y-5">
    <section class="space-y-2">
        <flux:heading size="xl" level="1">{{ __('account.privacy.heading') }}</flux:heading>
    ...
    <form wire:submit="save" class="space-y-5">
        <flux:card class="space-y-4">
            <div>
                <flux:heading size="sm">{{ __('account.privacy.guest_profile.title') }}</flux:heading>
        ...
        <flux:card class="space-y-4">
            <div>
                <flux:heading size="sm">{{ __('account.privacy.guest_contact.title') }}</flux:heading>
        ...
        <flux:card class="space-y-4">
            <div>
                <flux:heading size="sm">{{ __('account.privacy.host_listing.title') }}</flux:heading>
