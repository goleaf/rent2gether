            ...
            @switch($step)
                ...
                @case(8)
                    <div class="grid gap-4">
                        ...
                        @foreach(['entrancePhoto' => 'entrance', 'hallwayPhoto' => 'hallway', 'kitchenPhoto' => 'kitchen', 'bathroomPhoto' => 'bathroom', 'commonAreaPhoto' => 'common_area'] as $field => $slot)
                            <flux:field>
                                <flux:label>{{ __('host.property_wizard.photos.'.$slot) }}</flux:label>
