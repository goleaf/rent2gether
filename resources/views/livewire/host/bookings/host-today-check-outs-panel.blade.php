<flux:card class="space-y-4">
    <flux:heading size="md">{{ __('bookings.filters.today_checkout') }}</flux:heading>
    ...
    <div class="space-y-2">
        ...
        @empty
            <flux:text size="sm" class="text-zinc-600 dark:text-zinc-400">{{ __('bookings.empty_states.no_today_check_outs') }}</flux:text>
        @endforelse
    </div>
</flux:card>
