<div>
    <flux:button type="button" variant="primary" icon="magnifying-glass" class="w-full sm:w-auto" wire:click="open">
            ...
            <section class="absolute inset-x-0 bottom-0 max-h-[88vh] overflow-y-auto rounded-t-xl bg-white p-4 shadow-2xl dark:bg-zinc-950 sm:bottom-4 sm:left-auto sm:right-4 sm:top-4 sm:w-full sm:max-w-md sm:rounded-xl">
                <div class="space-y-4">
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <flux:button type="button" variant="ghost" size="sm" wire:click="$set('openSheet', false)" icon="x-mark">
