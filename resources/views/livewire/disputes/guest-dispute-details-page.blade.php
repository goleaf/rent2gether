<x-ui.section class="space-y-4 p-4">
    <div class="space-y-1">
        <flux:heading size="lg">
            <span class="inline-flex min-w-0 items-center gap-2">
                ...
                <span class="min-w-0">{{ __('disputes.title') }}</span>
            </span>
        </flux:heading>
    ...
    <div class="grid gap-2">
        <flux:button type="button" variant="primary" icon="plus">{{ __('disputes.actions.create_proposal') }}</flux:button>
        <flux:button type="button" variant="ghost" icon="camera">{{ __('disputes.actions.add_evidence') }}</flux:button>
    </div>
</x-ui.section>
