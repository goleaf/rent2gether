...
>
    <div class="grid grid-cols-4 gap-1">
        <a href="{{ url('/') }}" aria-current="page" class="flex min-h-12 flex-col items-center justify-center gap-1 rounded-lg bg-accent/10 px-2 text-xs font-medium text-accent-content dark:bg-white/10 dark:text-white">
