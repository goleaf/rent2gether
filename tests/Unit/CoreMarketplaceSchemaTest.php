...
class CoreMarketplaceSchemaTest extends TestCase
{
    ...
    public function test_core_marketplace_schema_contains_required_tables_columns_and_indexes(): void
    {
        ...
        $requiredColumns = [
            ...
            'media_items' => ['owner_type', 'owner_id', 'mediable_type', 'mediable_id', 'owner_user_id', 'collection', 'disk', 'path', 'thumbnail_path', 'thumb_path', 'mobile_path', 'full_path', 'original_filename', 'mime', 'mime_type', 'size', 'size_bytes', 'width', 'height', 'alt_text', 'caption_en', 'caption_ru', 'sort_order', 'is_primary', 'is_cover', 'status'],
