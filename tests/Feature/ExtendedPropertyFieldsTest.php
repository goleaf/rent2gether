...
class ExtendedPropertyFieldsTest extends TestCase
{
    ...
    public function test_host_extended_property_steps_update_data_and_block_other_hosts(): void
    {
        ...
        Livewire::actingAs($host)
            ...
            ->set('titleEn', 'Quiet shared flat')
            ->set('titleRu', 'Тихая общая квартира')
            ->set('shortDescriptionEn', 'A calm shared flat near daily transport.')
            ->set('shortDescriptionRu', 'Спокойная общая квартира рядом с транспортом.')
            ->set('fullDescriptionEn', 'Guests share the property, kitchen, bathroom, and common entrance.')
            ->set('fullDescriptionRu', 'Гости пользуются общим помещением, кухней, ванной и входом.')
